...
namespace Vuplex.WebView {
    ...
    #region Non-public members
        delegate void DeleteCookiesCallback(string requestId);
        delegate void GetCookiesCallback(string requestId, string serializedCookie);
        ...
        [AOT.MonoPInvokeCallback(typeof(DeleteCookiesCallback))]
        ...
        static void _initializePlugin() {
            ...
            WebView_setCookieCallbacks(
                ...
                Marshal.GetFunctionPointerForDelegate<DeleteCookiesCallback>(_handleDeleteCookiesResult)
            );
        }
