...
namespace Vuplex.WebView {
    ...
    public class AndroidWebView : BaseWebView,
        ...
        public override Material CreateMaterial() {
            ...
            var material = VXUtils.CreateAndroidMaterial();
        ...
        /// only has an effect in Native 2D Mode and has no effect if Native 2D Mode is disabled.
        /// </summary>
        /// <example>
        /// <code>
        /// #if UNITY_ANDROID &amp;&amp; !UNITY_EDITOR
    ...
    #region Non-public members
        ...
        async Task _initAndroid3D(int width, int height, AndroidJavaObject popupResultMessage) {
            ...
            _webView = new AndroidJavaObject(
                _3dWebViewClassName,
                gameObject.name,
                Texture.GetNativeTexturePtr().ToInt32(),
                width,
                height,
